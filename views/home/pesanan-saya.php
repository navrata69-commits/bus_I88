...
<section class="py-5 bg-light">
  <div class="container">
    ...
    <ul class="nav nav-pills justify-content-center mb-4" id="orderTabs">
      <li class="nav-item">
        <a href="/pesanan-saya-bus" class="btn nav-link active">
            <i class="bi bi-geo-alt me-2"></i> Pesanan Bus
        </a>
      </li>
      <li class="nav-item">
        <a href="/pesanan-saya-tour" class="btn nav-link">
    ...
    <div class="tab-content">
      ...
      <!-- TAB 1: RENTAL BUS -->
      <div class="tab-pane fade show active" id="bus-orders">
        <?php if (!empty($bus)): ?>
          <div class="row g-4">
            <?php foreach ($bus as $order): ?>
              <div class="col-md-6">
                <div class="card shadow-sm border-0 h-100">
                  <div class="card-body">
                    ...
                    <ul class="list-unstyled small mb-3">
                      <li><i class="bi bi-calendar-event me-2 text-danger"></i>Tanggal Sewa: <?= $order->start_date ?> → <?= $order->end_date ?></li>
                      <li><i class="bi bi-clock me-2 text-danger"></i>Total Hari: <?= $order->total_days ?></li>
                    ...
                    <div class="d-flex justify-content-end">
                      ...
                      <?php elseif ($order->status == 'pending'): ?>
                        <a href="/pelunasan-bus/<?= $order->id ?>" class="btn btn-danger btn-sm">
        ...
        <?php else: ?>
          <p class="text-center text-muted mt-4">Belum ada pesanan rental bus.</p>
        <?php endif; ?>
      </div>
