      ...
      <div class="col-lg-8">
        ...
        <div class="card shadow-sm border-0 mb-4">
          <div class="card-body">
            ...
            <div class="row mb-2">
              <div class="col-md-6"><strong>Total Penumpang:</strong></div>
              <div class="col-md-6"><?= htmlspecialchars($order->number_of_people) ?> Orang</div>
            </div>
            <div class="row mb-2">
        ...
        <div class="card shadow-sm border-0">
          <div class="card-body">
            ...
            <form method="POST" action="/pelunasan2/submit">
              <input type="hidden" name="rental_id" value="<?= $order->id ?>">
              <input type="hidden" name="rental_type" value="tour">
