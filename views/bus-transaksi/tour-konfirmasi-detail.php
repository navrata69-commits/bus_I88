<div class="container mt-4">
    ...
    <div class="card shadow-sm border-0 rounded-3">
        <div class="card-header bg-dark text-white">
            <h4 class="mb-0">Detail Pembayaran Wisata</h4>
        </div>
        <div class="card-body">
            ...
            <?php else: ?>
               ...
               <div class="text-end">
                    <?php if($order['payment_method'] == 'transfer') : ?>
                        <?php if ($order['tour_status'] === 'pending' || $order['payment_status'] === 'unpaid'): ?>
                            <form action="/tour/tolak/<?= $order['tour_id'] ?>"  style="display:inline;">
                                <button type="submit" class="btn btn-danger">
                                    <i class="bi bi-x-circle"></i> Tolak Pesanan
                                </button>
                            </form>  
                        <?php elseif ($order['tour_status'] === 'wait_confirmation' && $order['payment_status'] === 'paid'): ?>
                            <form action="/tour/confirm/<?= $order['tour_id'] ?>" style="display:inline;">
